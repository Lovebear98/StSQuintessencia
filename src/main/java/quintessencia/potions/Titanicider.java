...
public class Titanicider extends BrewedPotion {
    public static final String POTION_ID = makeID(Titanicider.class.getSimpleName());
    ...
    public Titanicider(ArrayList<AbstractReagent> list){
        this(list, 0);
    }
    ///Pass a potion with a set list and reactivity level - we can brew pre-boosted potions!
    public Titanicider(ArrayList<AbstractReagent> list, int i){
        super(NAME, POTION_ID, CardEnums.CONCOCTION, PotionSize.BOTTLE, PotionColor.WHITE);
    ...
    public CustomPotion makeCopy() {
        ...
        if(isInCombat()){
            ...
            if(Ingredients != null && Ingredients.isEmpty()){
                ...
                return new Titanicider(newlist, ReactionLevel);
            }
        }
        return new Titanicider(Ingredients, ReactionLevel);
    }
