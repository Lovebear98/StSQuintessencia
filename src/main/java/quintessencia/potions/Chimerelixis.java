...
public class Chimerelixis extends BrewedPotion {
    public static final String POTION_ID = makeID(Chimerelixis.class.getSimpleName());
    ...
    public Chimerelixis(ArrayList<AbstractReagent> list){
        this(list, 0);
    }
    ///Pass a potion with a set list and reactivity level - we can brew pre-boosted potions!
    public Chimerelixis(ArrayList<AbstractReagent> list, int i){
        super(NAME, POTION_ID, CardEnums.CONCOCTION, PotionSize.HEART, PotionColor.WHITE);
    ...
    public CustomPotion makeCopy() {
        ...
        if(isInCombat()){
            ...
            if(Ingredients != null && Ingredients.isEmpty()){
                ...
                return new Chimerelixis(newlist, ReactionLevel);
            }
        }
        return new Chimerelixis(Ingredients, ReactionLevel);
    }
