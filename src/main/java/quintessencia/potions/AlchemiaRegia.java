...
public class AlchemiaRegia extends BrewedPotion {
    public static final String POTION_ID = makeID(AlchemiaRegia.class.getSimpleName());
    ...
    public AlchemiaRegia() {
        this(new ArrayList<>());
    }
    ///Make a potion with a list but no pre-set reactivity
    public AlchemiaRegia(ArrayList<AbstractReagent> list){
        this(list, 0);
    }
    ///Pass a potion with a set list and reactivity level - we can brew pre-boosted potions!
    public AlchemiaRegia(ArrayList<AbstractReagent> list, int i){
        super(NAME, POTION_ID, CardEnums.CONCOCTION, PotionSize.FAIRY, PotionColor.WHITE);
    ...
    public CustomPotion makeCopy() {
        ...
        if(isInCombat()){
            ...
            if(Ingredients != null && Ingredients.isEmpty()){
                ...
                return new AlchemiaRegia(newlist, ReactionLevel);
            }
        }
        return new AlchemiaRegia(Ingredients, ReactionLevel);
    }
