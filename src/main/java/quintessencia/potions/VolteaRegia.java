...
public class VolteaRegia extends BrewedPotion {
    public static final String POTION_ID = makeID(VolteaRegia.class.getSimpleName());
    ...
    public VolteaRegia(ArrayList<AbstractReagent> list){
        this(list, 0);
    }
    ///Pass a potion with a set list and reactivity level - we can brew pre-boosted potions!
    public VolteaRegia(ArrayList<AbstractReagent> list, int i){
        super(NAME, POTION_ID, CardEnums.CONCOCTION, PotionSize.JAR, PotionColor.WHITE);
    ...
    public CustomPotion makeCopy() {
        ...
        if(isInCombat()){
            ...
            if(Ingredients != null && Ingredients.isEmpty()){
                ...
                return new VolteaRegia(newlist, ReactionLevel);
            }
        }
        return new VolteaRegia(Ingredients, ReactionLevel);
    }
