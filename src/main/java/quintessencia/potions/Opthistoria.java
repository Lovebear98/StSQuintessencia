...
public class Opthistoria extends BrewedPotion {
    public static final String POTION_ID = makeID(Opthistoria.class.getSimpleName());
    ...
    public Opthistoria(ArrayList<AbstractReagent> list){
        this(list, 0);
    }
    ///Pass a potion with a set list and reactivity level - we can brew pre-boosted potions!
    public Opthistoria(ArrayList<AbstractReagent> list, int i){
        super(NAME, POTION_ID, CardEnums.CONCOCTION, PotionSize.H, PotionColor.WHITE);
    ...
    public CustomPotion makeCopy() {
        ...
        if(isInCombat()){
            ...
            if(Ingredients != null && Ingredients.isEmpty()){
                ...
                return new Opthistoria(newlist, ReactionLevel);
            }
        }
        return new Opthistoria(Ingredients, ReactionLevel);
    }
