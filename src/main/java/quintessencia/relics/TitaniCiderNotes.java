...
public class TitaniCiderNotes extends BaseRelic {
    private static final String NAME = TitaniCiderNotes.class.getSimpleName(); //The name will be used for determining the image file as well as the ID.
    ...
    public TitaniCiderNotes() {
        super(ID, NAME, RARITY, SOUND);
        this.tips.add(new CardPowerTip(new FumeVeil()));
    }
    ...
    public void onEquip() {
        super.onEquip();
        ReplaceInDeck(AbstractCard.CardTags.STARTER_DEFEND, new FumeVeil());
    }
