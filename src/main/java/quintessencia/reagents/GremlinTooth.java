...
import static quintessencia.util.moreutil.Textures.GTooth;

public class GremlinTooth extends AbstractReagent {
    private static final PotionStrings potionStrings = CardCrawlGame.languagePack.getPotionString(makeID(GremlinTooth.class.getSimpleName()));
    private static final String[] DESC = potionStrings.DESCRIPTIONS;

    public GremlinTooth(){
        this.PotReactPercent = 0.75f;
    }
    ...
    public String REAGENT_ID() {
        return makeID(GremlinTooth.class.getSimpleName());
    }
    @Override
