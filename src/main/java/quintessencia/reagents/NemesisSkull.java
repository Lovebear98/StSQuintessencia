...
import static quintessencia.util.moreutil.Textures.NSkull;

public class NemesisSkull extends AbstractReagent {
    private static final PotionStrings potionStrings = CardCrawlGame.languagePack.getPotionString(makeID(NemesisSkull.class.getSimpleName()));
    private static final String[] DESC = potionStrings.DESCRIPTIONS;

    public NemesisSkull(){
        this.PotReactPercent = 0.2f;
    }
    ...
    public String REAGENT_ID() {
        return makeID(NemesisSkull.class.getSimpleName());
    }
    @Override
    ...
    @Override
    public void onDraw(AbstractPotion pot) {
        React(pot);
    }
